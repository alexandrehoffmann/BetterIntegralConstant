#ifndef BIC_MISC_IS_COMPARABLE_TO_HPP
#define BIC_MISC_IS_COMPARABLE_TO_HPP
 ...
 * requires BIC::misc::Is_ComparableTo<T, U>
...
concept Is_ComparableTo = requires(Lhs a, Rhs b) {
...
#endif // BIC_MISC_IS_COMPARABLE_TO_HPP
