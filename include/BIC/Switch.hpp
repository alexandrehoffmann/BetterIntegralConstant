...
constexpr switchCase(Fixed<Size, FIRST_CASE>, Fixed<Size, BOUND_CASE>, Size targetCase, UnaryFunc&& func) { return switchCase(seq<Size, FIRST, BOUND>, targetCase, std::forward<UnaryFunc>(func)); }
